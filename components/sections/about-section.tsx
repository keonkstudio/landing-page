        ...
        <div className="space-y-12 md:space-y-15">
          <div className="flex flex-col items-center gap-3.5 text-center md:gap-5">
            ...
            <p className="text-2xl font-semibold md:text-4xl">
              Komunitas Roblox{" "}
              <span className="mt-2 inline-block size-fit rotate-3 border-3 border-dashed border-red-500 px-2 text-red-400">Kucink</span>
            </p>
            <p className="md:text-md max-w-145 text-sm text-gray-500">
